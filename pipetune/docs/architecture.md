...
Fully consumed capture chunks are returned to PipeWire with zero valid size,
so a property-only graph wake cannot publish retained sample storage as fresh
PCM.
